...
def welcome_message(chat_id: str, txt: str = "", user_id: str = "", username: str = "", fullname: str = ""):
...
def select_batch_size(chat_id: str, txt: str = "", user_id: str = "", username: str = "", fullname: str = ""):
...
def select_lr(chat_id: str, txt: str = "", user_id: str = "", username: str = "", fullname: str = ""):
...
def select_batch_norm(chat_id: str, txt: str = "", user_id: str = "", username: str = "", fullname: str = ""):
...
def select_filters(chat_id: str, txt: str = "", user_id: str = "", username: str = "", fullname: str = ""):
...
def select_dropout(chat_id: str, txt: str = "", user_id: str = "", username: str = "", fullname: str = ""):
...
def select_image_size(chat_id: str, txt: str = "", user_id: str = "", username: str = "", fullname: str = ""):
...
def confirm_training(chat_id: str, txt: str = "", user_id: str = "", username: str = "", fullname: str = ""):
